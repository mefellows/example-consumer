...
cat pact-setup.md
echo ""
claude --mcp-config ~/.config/claude/mcp.json --allowedTools "Read,Write,CreateFile,mcp__smartbear__contract-testing_generate_pact_tests" --print --output-format text < pact-setup.md > pact-setup-results.md
