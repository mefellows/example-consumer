...
echo "📊 Running Pact setup..."
cat pact-setup.md
echo ""
claude --mcp-config ~/.config/claude/mcp.json --allowedTools "Read,Write,CreateFile" --print --output-format text < pact-setup.md > pact-setup-results.md
