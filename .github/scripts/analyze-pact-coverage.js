...
class PactCoverageAnalyzer {
  ...
  generateMarkdownReport() {
    ...
    markdown += `|--------|-------|\n`;
    markdown += `| Total API Methods | ${report.summary.totalApiMethods} |\n`;
    markdown += `| Covered Methods | ${report.summary.coveredMethods} |\n`;
    markdown += `| Coverage Percentage | ${report.summary.coveragePercentage}% |\n`;
    markdown += `| Total Pact Interactions | ${report.summary.totalPactInteractions} |\n`;
    markdown += `| Pact Test File Status | ${report.summary.pactTestFileStatus.isEmpty ? '❌ Empty/Missing' : '✅ Has Tests'} |\n\n`;
